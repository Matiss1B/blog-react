                    ...
                    <div className="flex gap2">
                        <div className="flex col gap2 home-page-welcome-title">
                            <div className="flex col">
                                <h1>Welcome</h1>
                                <h1 className={`flex gap2 center-y`}>to <h1 className={`welcome-title`}>BlogIt</h1></h1>
                            </div>
                        ...
                        <div className="image-box hidden-mobile">
                            <div className="circle">
                                <img src="https://images.unsplash.com/photo-1530042133068-0296a09adf7b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjV8fEJsb2d8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60" alt=""/>
                            </div>
                        </div>
                    </div>
